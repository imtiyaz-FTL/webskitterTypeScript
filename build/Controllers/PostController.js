...
/**
 * Type guard to check if an error is a Joi validation error
 */
var isJoiError = function (error) {
    return (error === null || error === void 0 ? void 0 : error.isJoi) === true;
};
/**
 * add new post
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, addPost(postModelValidation)];
            case 2:
                newPost = _a.sent();
                if (newPost) {
                    ...
                    return [2 /*return*/, next(res.status(400).json({ message: "Invalid details provided." }))];
                }
                return [3 /*break*/, 4];
            case 3:
                error_2 = _a.sent();
                if (isJoiError(error_2)) {
                    return [2 /*return*/, next(res.status(400).json({ message: "Invalid details provided." }))];
                }
                next(error_2);
                return [3 /*break*/, 4];
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (getPosts) {
                    ...
                    return [2 /*return*/, next(res.status(404).json({ message: "Not found." }))];
                }
                return [3 /*break*/, 3];
            case 2:
                error_3 = _a.sent();
                if (isJoiError(error_3)) {
                    return [2 /*return*/, next(res.status(400).json({ message: "Invalid details provided." }))];
                }
                next(error_3);
                return [3 /*break*/, 3];
...
var getPost = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, PostValidation_1.PostIdValidation.validateAsync(req.params.postId)];
            case 1:
                postIdValidation = _a.sent();
                return [4 /*yield*/, Post_1.default.findById(postIdValidation)
                        .select("_id title description vote createdAt updatedAt")
                        .populate("user", "username name surname")];
            case 2:
                getPosts = _a.sent();
...
var deletePost = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                postIdValidation = _a.sent();
                return [4 /*yield*/, Post_1.default.findByIdAndDelete(postIdValidation)];
            case 2:
                deletePosts = _a.sent();
                if (deletePosts) {
...
var updatePost = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, PostValidation_1.UpdatePostValidation.validateAsync(req.body)];
            case 1:
                resUpdatePostValidation = _a.sent();
                return [4 /*yield*/, Post_1.default.findByIdAndUpdate({ _id: resUpdatePostValidation.postId }, {
                        $set: {
